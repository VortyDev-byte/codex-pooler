...
| Unsupported parameter | Correlate the gateway error with the installed client version; do not assume old request-shape reports describe your version. |
